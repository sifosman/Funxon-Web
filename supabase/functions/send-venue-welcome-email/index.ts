      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
          ...
          <div style="background: #f5f5f5; padding: 20px; border-radius: 8px; margin: 25px 0;">
            ...
            <p style="margin-bottom: 0;">Complete your venue application to set up your venue profile, add photos and details, and start receiving bookings.</p>
          </div>
...
The Funcxon Team
    ...
    console.error('Error sending venue welcome email:', error);

    return new Response(
      JSON.stringify({
        error: 'Failed to send venue welcome email',
