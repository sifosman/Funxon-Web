  ...
  return (
    <div className="fx-container fx-section">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="mb-2 text-3xl font-bold" style={{ fontFamily: "'Playfair Display', serif", color: '#123f5c' }}>Calendar Updates</h1>
        <p className="mb-6 text-sm" style={{ fontFamily: "'Montserrat', sans-serif", color: '#72787e' }}>Tasks with due dates and calendar events appear here.</p>
